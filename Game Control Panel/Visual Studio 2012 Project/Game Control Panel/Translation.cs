...
namespace Game_Control_Panel
{
    class Translation
    {
        ...
        public enum WORDS
        {
            ...
            Robot1VideoFeed,//Robot1=82 for the video feed window
            Robot2VideoFeed//Robot2=83 for the video feed window
            //If additional words are added the NUMBEROFWORDS constant should be changed and the dictonary should be updated
        };
        private const byte NUMBEROFWORDS = 84;
        ...
        private string[,] dictionary = {
            ...
            {"3 Minutes","三分钟"},//ThreeMinutes = 19, for Game Length combo box
            {"4 Minutes","四分钟"},//FourMinutes = 20, for Game Length combo box
            {"5 Minutes","五分钟"},//FiveMinutes = 21, for Game Length combo box
            {"6 Minutes","六分钟"},//SixMinutes = 22, for Game Length combo box
            {"7 Minutes","七分钟"},//SevenMinutes = 23, for Game Length combo box
            {"8 Minutes","八分钟"},//EightMinutes = 24, for Game Length combo box
            {"9 Minutes","九分钟"},//NineMinutes = 25, for Game Length combo box
            {"10 Minutes","十分钟"},//TenMinutes = 26, for Game Length combo box
            {"15 Minutes","十五分钟"},//FifteenMinutes = 27, for Game Length combo box
            {"20 Minutes","二十分钟"},//TwentyMinutes = 28, for Game Length combo box
            {"25 Minutes","二十五分钟"},//TwentyFiveMinutes = 29, for Game Length combo box
            {"30 Minutes","三十分钟"},//ThirtyMinutes = 30, for Game Length combo box
            {"35 Minutes","三十五分钟"},//ThirtyFiveMinutes = 31, for Game Length combo box
            {"40 Minutes","四十分钟"},//FourtyMinutes = 32, for Game Length combo box
            {"45 Minutes","四十五分钟"},//FourtyFiveMinutes = 33, for Game Length combo box
            {"50 Minutes","五十分钟"},//FiftyMinutes = 34, for Game Length combo box
            {"55 Minutes","五十五分钟"},//FiftyFiveyMinutes = 35, for Game Length combo box
            {"60 Minutes","六十分钟"},//SixtyMinutes = 36, for Game Length combo box
